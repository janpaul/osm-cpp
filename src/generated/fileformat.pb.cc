...
const ::uint32_t TableStruct_fileformat_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    ~0u,  // no _extensions_
    PROTOBUF_FIELD_OFFSET(::Blob, _impl_._oneof_case_[0]),
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
...
const ::_pbi::TcParseTable<2, 3, 0, 23, 2> BlobHeader::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(BlobHeader, _impl_._has_bits_),
    0, // no _extensions_
...
class Blob::_Internal {
 public:
  ...
  static constexpr ::int32_t kOneofCaseOffset =
    PROTOBUF_FIELD_OFFSET(::Blob, _impl_._oneof_case_);

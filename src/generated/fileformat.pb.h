...
class BlobHeader final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:BlobHeader) */ {
 public:
  ...
  inline BlobHeader(const BlobHeader& from)
      : BlobHeader(nullptr, from) {}
...
class Blob final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Blob) */ {
 public:
